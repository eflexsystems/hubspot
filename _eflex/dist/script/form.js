...
function form(formName, form_Group1, form_Group2, form_Group3) {
  ...
  if (formSteps = 2) {
    ...
    $( formName + " #form-next-1" ).click(function() {
      ...
      $( formName + " #form-prev-1, " + formName + " #hs-button.primary" ).css( "display", "block" );
    ...
    $( "#form-prev-1" ).click(function() {
      $( "#form-prev-1, #hs-button.primary" ).css( "display", "none" );
...
form('#download_request', downloadRequest_Group1, downloadRequest_Group2 );